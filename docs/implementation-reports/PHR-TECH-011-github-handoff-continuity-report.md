...
The final fleet alignment upgrades the vendored runtime to Handoff 0.5.1,
suppresses portable Python bytecode, adopts shared workflow 2.20.0 and declares
read-only workflow permissions. It does not change product or ingress behavior.
