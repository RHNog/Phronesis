...
- Modification reason: Product Owner remediation added an installable-web-app contract, cache-safe current-origin icon metadata, and a non-overlapping Event Operations layout gate.
