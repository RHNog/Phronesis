# PHR-TECH-008 Release Notes

Phronesis now recognizes explicit equivalent Pokémon set labels between TCGplayer and TCGdex, increasing strict Pikachu thumbnail coverage from 12 to 25 of the first 40 snapshot results without fuzzy matching.
