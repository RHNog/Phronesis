...
- The open Bulk form now shows `Take or upload picture` before `Add Bulk`, including a pre-submit preview; the resulting saved line receives the selected evidence automatically.
