...
- [ ] [P1] Approve provenance/licensing and curate a powered English Pokémon holdout before activating any `PHR-TECH-014` auto-accept policy.
...
- [ ] [P0] Disable Funnel port 10000 with `tailscale funnel --https=10000 off` when the approved public worker window ends; do not alter private port 9443.
...
- [x] [P1] Authorize and implement the daily 03:00 LigaMagic export schedule after the supervised profile proved reliable (`PHR-API-013`).
